...
if __name__ == '__main__':
    ...
    parser.add_argument('-net', typr=str, required=True, help='net type')
    ...
    parser.add_argument('-num_iter', type=int, default=100, help='num of iterations')
    parser.add_argument('-gpus', nargs='+', type=int, default=0, help='gpu device')
    args = parser.parse_args()

    cifar100_trianing_loader = get_training_dataloader(
    ...
    epochs = int(args.num_iter / len(cifar100_trianing_loader)) + 1
    n = 0
    ...
    for epoch in range(epochs):
        net.train()
        for batch_index, (images, labels) in enumerate(cifar100_trianing_loader):
            if n > args.num_iter:
                break
